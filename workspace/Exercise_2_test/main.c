...
uint8_t MasterType1 [1] = { 0};
uint8_t MasterType0 [1] = { 230};
...
int main(void) {
    ...
    P3DIR |= BIT6;
    P3SEL |= BIT6 ;             // P3 .6 TA0 .2 option -> found in device specific datasheet(see ilias)
    ...
    I2C_Master_WriteReg(72, 0, test, 1);

    //working example
//    while(1) {
//        // read channel 0 for display contrast
//        I2C_Master_ReadReg(SLAVE_ADDR, CMD_TYPE_0_SLAVE, TYPE_0_LENGTH);
//        // copyfrom ReceiveBuffer to slaveType0
//        CopyArray(ReceiveBuffer, SlaveType0, TYPE_0_LENGTH);
//        uint8_t test [1] = {SlaveType0[3]};
//        _delay_cycles(100);
//        I2C_Master_WriteReg(SLAVE_ADDR, CMD_TYPE_0_MASTER, test, 1);
//        _delay_cycles(1000000);
//
//        // read channel 2 for stopping the sound
//        I2C_Master_ReadReg(SLAVE_ADDR, 2, TYPE_0_LENGTH);
//        // copyfrom ReceiveBuffer to slaveType0
//        CopyArray(ReceiveBuffer, SlaveType0, TYPE_0_LENGTH);
//        _delay_cycles(100000);
//        char test3 = SlaveType0[3];
//        if (test3 > 100 ) {
//            TA0CCR0 = 0;                // PWM Period : 1000 us
//        } else  {
//            // read channel 1 for playing sound
//           I2C_Master_ReadReg(SLAVE_ADDR, 1, TYPE_0_LENGTH);
//           // copyfrom ReceiveBuffer to slaveType0
//           CopyArray(ReceiveBuffer, SlaveType0, TYPE_0_LENGTH);
//           char test2 = SlaveType0[3];
//           _delay_cycles(100);
//           TA0CCR0 = 10000 + test2*10;                // set PWM period according to joystick position
//       }
//       _delay_cycles(1000000);
//
//    }
